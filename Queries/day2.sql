...
-- 1.departments
-- select * from sql_challenge.cleaned_departments
-- where
...
-- 2.employees
-- select * from sql_challenge.cleaned_employees
-- where
...
-- select * from sql_challenge.cleaned_salaries
-- where
...
-- 4.attendance
-- select * from sql_challenge.cleaned_attendance
-- where    
...
-- 5.performance
select * from sql_challenge.cleaned_performance
where
emp_id is null or emp_id = ''
or
